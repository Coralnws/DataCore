...
#[derive(Debug)]
pub struct DataCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DataCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DataCore processing");
    
    let mut processor = DataCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DataCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DataCoreProcessor::new(false);
